  ...
  async execute(client, message, args) {
    if (
      ...
      const permEmbed = new Discord.MessageEmbed()
        .setColor(color)
        .setDescription(
          "**Je désactive toute les permissions à tous les rôles.**"
        )
        .addField(
          "`Permissions Désactivé`",
          "Permission: **ADMINISTRATOR**, **MANAGE_ROLES**, **KICK_MEMBERS**, **BAN_MEMBERS**, **MANAGE_WEBHOOKS**, **MUTE_MEMBERS**, **MOVE_MEMBERS**, **MANAGE_GUILD**"
        );
      ...
      const embed = new Discord.MessageEmbed()
        .setColor(color)
        .setTitle(
          `${message.author.tag} à désactivé toutes les __permissions__ du serveur`
        )
        .setDescription(
