    ...
    if (
      ...
      if (args[0] == "create") {
        if (args[1] == "on") {
          ...
          const embed = new Discord.MessageEmbed()
            .setDescription(
              `**L'antiChannel Create** est maintenant **activé**`
            )
            .setColor(color);
          message.channel.send({ embeds: [embed] });
        } else if (args[1] == "off") {
          ...
          const embed = new Discord.MessageEmbed()
            .setDescription(
              `**L'antiChannel Create** est maintenant **désactivé**`
            )
            .setColor(color);
          message.channel.send({ embeds: [embed] });
        }
        ...
        if (args[1] == "on") {
          ...
          const embed = new Discord.MessageEmbed()
            .setDescription(
              `**L'antichannel Delete** est maintenant **activé**`
            )
            .setColor(color);
          message.channel.send({ embeds: [embed] });
        } else if (args[1] == "off") {
          ...
          const embed = new Discord.MessageEmbed()
            .setDescription(
              `**L'antichannel Delete** est maintenant **désactivé**`
            )
            .setColor(color);
          message.channel.send({ embeds: [embed] });
        }
        ...
        if (args[1] == "on") {
          ...
          const embed = new Discord.MessageEmbed()
            .setDescription(
              `**L'antiChannel Update** est maintenant **activé**`
            )
            .setColor(color);
          message.channel.send({ embeds: [embed] });
        } else if (args[1] == "off") {
          ...
          const embed = new Discord.MessageEmbed()
            .setDescription(
              `**L'antiChannel Update** est maintenant **désactivé**`
            )
            .setColor(color);
          message.channel.send({ embeds: [embed] });
        } else {
