...
module.exports = {
    ...
    async execute(client, message, args) {
        if (!args[0]) return message.reply('> Merci de preciser un membre pour lui ajouter un rôle');
        if (!args[0]) return message.reply('> Merci de preciser un rôle à donner au membre');
