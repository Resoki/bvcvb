  ...
  async execute(client, message, args) {
    ...
    await ChaosWords({
      ...
      embed: {
        ...
        description:
          "Tu as **{{time}}** pour trouver les mots cachés dans la phrase ci-dessous.",
        color: `${color}`,
        field1: "Phrase:",
      ...
      wrongWordMessage:
        "Mauvais mot ! Tu as **{{remaining_tries}}** essais restants.",
      correctWordMessage:
        "GG, **{{word}}** est correcte ! Vous devez trouver **{{remaining}}** mot(s).",
      time: 60000,
