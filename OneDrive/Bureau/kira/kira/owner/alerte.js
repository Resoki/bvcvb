...
module.exports = {
  ...
  async execute(client, message, args) {
    if (
      ...
      let alertesalon = `<#${alertefunny.get(
        `${message.guild.id}.alerteperm`
      )}>`;
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .setDescription(
          `__Alertes actuelles:__\n\nAlerte Admin: __${alerteadmin}__\nAlerte Ban: __${alerteban}__\n Alerte Role: __${alerterole}__\n\n**Salon d'alerte:** ${alertesalon}`
        )
        .setColor(color)
        .setFooter({
          text: `Si vous avez apporté des modifications refaite la commande pour actualiser ce message`,
        });
      ...
      message.channel
        .send({ embeds: [embed], components: [panelselect] })
        .then(async (msg) => {
          //Ping admin
          const adminpingembed = new Discord.MessageEmbed()
            .setDescription(
              `**Voulez vous prévenir les owners lorsqu'une permission __Administrateur__ sera ajoutée ?**`
            )
            .setColor(color);
          ...
          const banpingembed = new Discord.MessageEmbed()
            .setDescription(
              `**Voulez vous prévenir les owners lorsqu'une permission __Bannir des membres__ sera ajoutée ?**`
            )
            .setColor(color);
          ...
          const rolepingembed = new Discord.MessageEmbed()
            .setDescription(
              `**Voulez vous prévenir les owners lorsqu'une permission __Gérer les roles__ sera ajoutée ?**`
            )
            .setColor(color);
          ...
          collectorX.on("collect", async (f) => {
            ...
            if (value === "all") {
              ...
              msg.channel
                .send({
                  content: `Les ajouts de roles contenant la permission \`Admin\`, \`Ban\`, \`Role\` seront désormais ping dans le salon d'arlerte`,
                })
                .then((msg) => {
            ...
            if (value === "funnyoff") {
              ...
              msg.channel
                .send({ content: `Toutes les alertes ont étaient désactivées` })
                .then((msg) => {
                  setTimeout(() => msg.delete(), 7000);
                });
            }
            ...
            if (value === "admin") {
              msg.edit({
                embeds: [adminpingembed],
                components: [adminpingrow],
              });
            }
            ...
            if (value === "admon") {
              ...
              msg.channel
                .send({
                  content: `Les ajouts de roles contenant la permission \`Admin\` seront désormais ping dans le salon d'arlerte`,
                })
                .then((msg) => {
            ...
            if (value === "banon") {
              ...
              msg.channel
                .send({
                  content: `Les ajouts de roles contenant la permission \`Bannir des membres\` seront désormais ping dans le salon d'arlerte`,
                })
                .then((msg) => {
                  setTimeout(() => msg.delete(), 6000);
                });
            ...
            if (value === "roleon") {
              ...
              msg.channel
                .send({
                  content: `Les ajouts de roles contenant la permission \`Role\` seront désormais ping dans le salon d'arlerte`,
                })
                .then((msg) => {
                  setTimeout(() => msg.delete(), 6000);
                });
