...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    if (
      ...
      message.channel
        .send({ embeds: [embed], components: [punition] })
        .then(async (msg) => {
          ...
          collector.on("collect", async (c) => {
            ...
            if (value === "derank") {
              ...
              c.reply({
                content: `La punition en cas de __raid__ sera désormais un **derank**`,
                ephemeral: true,
              });
              ...
              c.reply({
                content: `La punition en cas de __raid__ sera désormais un **kick**`,
                ephemeral: true,
              });
            ...
            if (value === "ban") {
              ...
              c.reply({
                content: `La punition en cas de __raid__ sera désormais un **ban**`,
                ephemeral: true,
              });
              msg.edit({ embeds: [ban] });
            }
