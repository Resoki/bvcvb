...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    if (
      ...
      //////////////                    antilink                    ///////////////////////////
      let antilink =
        (await al.get(`config.${message.guild.id}.antilinkinvite`)) ||
        al.get(`config.${message.guild.id}.antilinkall`);
      ...
      //////////////                    antichannelcreate                    ///////////////////////////
      let antichannelcreate = await atc.get(
        `config.${message.guild.id}.antichannelcreate`
      );
      ...
      //////////////                    antichanneldelete                    ///////////////////////////
      let antichanneldelete = await atd.get(
        `config.${message.guild.id}.antichanneldelete`
      );
      ...
      //////////////                    antichannelupdate                    ///////////////////////////
      let antichannelupdate = await acu.get(
        `config.${message.guild.id}.antichannelupdate`
      );
      ...
      //////////////                    antirolecreate                    ///////////////////////////
      let antirolecreate = await atr.get(
        `config.${message.guild.id}.antirolecreate`
      );
      ...
      //////////////                    antiroledelete                    ///////////////////////////
      let antiroledelete = await ard.get(
        `config.${message.guild.id}.antiroledelete`
      );
      ...
      //////////////                    antiroleupdate                    ///////////////////////////
      let antiroleupdate = await aru.get(
        `config.${message.guild.id}.antiroleupdate`
      );
      ...
      //////////////                    antieveryone                    ///////////////////////////
      let antieveryone = await ae.get(
        `config.${message.guild.id}.antieveryone`
      );
      ...
      const panel = new Discord.MessageEmbed()
        ...
        .setFooter({
          text: `Faites la commande ${pf}bypass pour obtenir des informations supplémentaires`,
        })
        .setColor(color);
      ...
      message.channel
        .send({ embeds: [panel], components: [secu, panelselect] })
        .then(async (msg) => {
          //anti channel create
          const antichannelembed = new Discord.MessageEmbed()
            .setDescription(
              `**Comment voulez vous configurer __l'anti channel create__**`
            )
            .setColor(color);
          ...
          const antichanneldembed = new Discord.MessageEmbed()
            .setDescription(
              `**Comment voulez vous configurer __l'anti channel delete__**`
            )
            .setColor(color);
          ...
          const antichanneupdembed = new Discord.MessageEmbed()
            .setDescription(
              `**Comment voulez vous configurer __l'anti channel update__**`
            )
            .setColor(color);
          ...
          const antirolecreateembed = new Discord.MessageEmbed()
            .setDescription(
              `**Comment voulez vous configurer __l'anti role create__**`
            )
            .setColor(color);

          const antirolecreaterow =
          ...
          const antiroledeleteembed = new Discord.MessageEmbed()
            .setDescription(
              `**Comment voulez vous configurer __l'anti role delete__**`
            )
            .setColor(color);

          const antiroledeleterow =
            new Discord.MessageActionRow().addComponents(
              new Discord.MessageSelectMenu()
                .setCustomId("Funny")
                .setPlaceholder(`Configurer`)
          ...
          const antiroleupembed = new Discord.MessageEmbed()
            .setDescription(
              `**Comment voulez vous configurer __l'anti role update__**`
            )
            .setColor(color);
          ...
          const antiwbembed = new Discord.MessageEmbed()
            .setDescription(
              `**Comment voulez vous configurer __l'anti WebHook__**`
            )
            .setColor(color);
          ...
          const punishembed = new Discord.MessageEmbed()
            .setDescription(
              `**Comment voulez vous configurer la __Punition__**`
            )
            .setColor(color);
          ...
          const antiupdateembed = new Discord.MessageEmbed()
            .setDescription(
              `**Comment voulez vous configurer l' __anti update__**`
            )
            .setColor(color);
              ...
              .addOptions([
                {
                  ...
                  emoji: "🔒",
                  description:
                    "Attention plus personne ne pourra rejoindre le serveur",
                },
                {
          ...
          collectorX.on("collect", async (f) => {
            ...
            if (value === "acc") {
              msg.edit({
                embeds: [antichannelembed],
                components: [antichannelrow],
              });
            }
            ...
            if (value === "acd") {
              msg.edit({
                embeds: [antichanneldembed],
                components: [antichannedlrow],
              });
            }
            ...
            if (value === "acu") {
              msg.edit({
                embeds: [antichanneupdembed],
                components: [antichanneduprow],
              });
            }
            ...
            if (value === "arc") {
              msg.edit({
                embeds: [antirolecreateembed],
                components: [antirolecreaterow],
              });
            }
            ...
            if (value === "ard") {
              msg.edit({
                embeds: [antiroledeleteembed],
                components: [antiroledeleterow],
              });
            }
            ...
            if (value === "au") {
              msg.edit({
                embeds: [antiupdateembed],
                components: [antiupdaterow],
              });
            }
          ...
          collector.on("collect", async (c) => {
            ...
            if (value === "active") {
              c.reply({
                content: `**Toutes les securitées ont étaient activées avec succés**`,
                ephemeral: true,
              });
              ...
              c.reply({
                content: `**Toutes les securitées ont étaient désactivées avec succés**`,
                ephemeral: true,
              });
