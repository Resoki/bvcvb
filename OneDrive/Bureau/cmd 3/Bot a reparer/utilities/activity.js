  ...
  async execute(client, message, args, color) {
    ...
    if (!message.member.voice.channel)
      return message.reply(
        `Vous n'êtes pas connecté a un salon Vocal !\n Vous ne pouvez pas jouer sans etre en vocal :(`
      );
    const base = new Discord.MessageActionRow().addComponents(
...
`
    ...
    message
      .reply({ embeds: [embedbase], components: [base] })
      .then(async (msg) => {
              ...
              client.discordTogether
                ...
                .then(async (invite) => {
                  const embedPoker = new Discord.MessageEmbed()
                    ...
                    .setColor(color)
                    .setImage(
                      "https://media1.giphy.com/media/gdMvZbOabADH44Xghj/giphy.gif"
                    )
                    .setDescription(
              ...
              client.discordTogether
                ...
                .then(async (invite) => {
                  const embedChess = new Discord.MessageEmbed()
                    ...
                    .setColor(color)
                    .setImage(
                      "https://c.tenor.com/uImkKflPEncAAAAC/chess-anime.gif"
                    )
                    .setDescription(
              ...
              client.discordTogether
                ...
                .then(async (invite) => {
                  const embedCheckers = new Discord.MessageEmbed()
                    ...
                    .setColor(color)
                    .setImage(
                      "https://c.tenor.com/VR5AyND05ZwAAAAC/toy-story-woody.gif"
                    )
                    .setDescription(
              ...
              client.discordTogether
                ...
                .then(async (invite) => {
                  const embedBetrayal = new Discord.MessageEmbed()
                    ...
                    .setColor(color)
                    .setImage(
                      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0yhOfQHkgAeLgxTH7zku6nwKD3wmvxGmgWHDFeuGp3XB68JC3LXQQTMWtKk5PA7NfRDU&usqp=CAU"
                    )
                    .setDescription(
              ...
              client.discordTogether
                ...
                .then(async (invite) => {
                  const embedFishington = new Discord.MessageEmbed()
                    ...
                    .setColor(color)
                    .setImage(
                      "https://i2.wp.com/i.giphy.com/media/uVsTi8HLm7AK6eQE1l/giphy.gif"
                    )
                    .setDescription(
              ...
              client.discordTogether
                ...
                .then(async (invite) => {
                  const embedLettertile = new Discord.MessageEmbed()
                    ...
                    .setColor(color)
                    .setImage(
                      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDtTy2ZuwzX922x4TiDA0eBX4L6brn3rDPsqlBFsU3A7Mdi0x5kcv2hrDsWKhmMtN-2cw&usqp=CAU"
                    )
                    .setDescription(
              ...
              client.discordTogether
                ...
                .then(async (invite) => {
                  const embedWordsnack = new Discord.MessageEmbed()
                    ...
                    .setColor(color)
                    .setImage(
                      "https://cdn.dribbble.com/users/469450/screenshots/3718372/happy_pizza.gif"
                    )
                    .setDescription(
              ...
              client.discordTogether
                ...
                .then(async (invite) => {
                  const embedSpellcast = new Discord.MessageEmbed()
                    ...
                    .setColor(color)
                    .setImage(
                      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5cy9zZT748pe42eus1FqAtp0nGfYKFZ1O94JYtXFfw9Ix7Hi8OHDNYXEkoxk_3o25C0U&usqp=CAU"
                    )
                    .setDescription(
              ...
              client.discordTogether
                ...
                .then(async (invite) => {
                  const embedAwkword = new Discord.MessageEmbed()
                    ...
                    .setColor(color);
                  setImage(
                    "https://i.gifer.com/origin/22/22b5e9b5f625950755aafc15845f0a43.gif"
                  )
                    .setDescription(
              ...
              client.discordTogether
                ...
                .then(async (invite) => {
                  const embedSketchheads = new Discord.MessageEmbed()
                    ...
                    .setColor(color)
                    .setImage(
                      "https://64.media.tumblr.com/5923c82723517f9e55187d52b949a682/d2ae8118f856b349-27/s500x750/fb7f7e597bb3611311110d1fee786757f9108fd3.gifv"
                    )
                    .setDescription(
